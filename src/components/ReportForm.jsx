...
export default function ReportForm() {
    ...
    const [step1ReviewReason, setStep1ReviewReason] = useState("");
    const [isSubmittingStep1Review, setIsSubmittingStep1Review] = useState(false);
    const [step1ReviewResult, setStep1ReviewResult] = useState(null);
